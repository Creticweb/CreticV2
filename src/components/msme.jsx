    ...
    <Helmet>
     <title>MSME Registration | Cretic Solutions</title>
      ...
      <div class="main-content-wrapper">
      	<section class="crumina-stunning-header section-image-bg-yellow">
      	
		<div class="container">
			<div class="stunning-header-content align-center">
				<h1 class="page-title text-white">MSME REGISTRATION</h1>
 	        ...
 	        <div class="row">
 	          <div class="col-lg-8 col-md-10 col-sm-12 col-xs-12 m-auto align-center">
 	           <header class="crumina-module crumina-heading mb-5">
 	            ...
 	            <h2 class="heading-title">Get your MSME Registration to avail various benefits</h2>
 	            </div>
     ...
     <div class="wrapper light-wrapper">
      <div class="container inner">
        <div class="row gutter-60 gutter-md-30 process-wrapper arrow text-center">
          <div class="col-md-4">
             ...
             <div class="heading-decoration"></div>
            <h5>Get your MSME Registration to avail various benefits</h5>
          </div>
          <div class="col-md-4"> <img class="img-icon" src={home} alt="home" /><br/>
          <div class="heading-decoration"></div>
            <h5>Get preference in Tender allotments.</h5>
          </div>
          <div class="col-md-4"> <img class="img-icon" src={docu} alt="compliances" /> <br/>
          <div class="heading-decoration"></div>
            <h5>Govt. Support to recover delayed Payments</h5>
          </div>
        </div>
      </div>
    </div>
                  ...
                  <div className="main-pricing-content">
                    ...
                    <ul className="pricing-tables-position">
                      <li className="position-item">
                        <span className="font-weight-bold">MSME Registration</span>
                      </li>
                      <li className="position-item">
                    ...
                    <h2 className="rate">₹<span className="pricing-price">179</span></h2>
      ...
      <div class="container inner">
         <header class="crumina-module crumina-heading mb-5">
 	            <div class="title-text-wrap">
 	            <h2 class="heading-title">Udyog Aadhaar Eligibility</h2>
 	            </div>
 	           <div class="heading-decoration"></div>
 	         </header>
        <div class="row">
